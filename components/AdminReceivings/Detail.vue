...
<template>
  ...
  <div class="row">
    ...
    <div class="col-12 col-md-4">
      <b>{{ $getTranslation('shared.columns.supplier') }}</b>: {{ adminReceiving.adminReceiving.supplier_name + ' - ' + adminReceiving.adminReceiving.supplier_store_name }}
    </div>
    <div class="col-12 col-md-4">
  ...
  <div class="mt-5">
    <forms-data-table :title="$getTranslation('shared.labels.list') + ' ' + $getTranslation('shared.columns.item')" :columns="tableColumn.adminReceivingItemsTable" :module="`warehouse-receivings/${adminReceivingId()}/items`" :hasCreateButton="false" ref="adminReceivingItemsTable" @customButtonClick="openAdminReceivingItemPurchase" :withWarehouseId="true" />

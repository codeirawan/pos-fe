...
<template>
  <q-table bordered class="mx-0" dense :rows="expense.expenseForm?.entries" :columns="tableColumn.expenseEntriesFormTable" row-key="name"
    ...
    <template v-slot:top>
      ...
      <q-space />
      <q-btn color="primary" @click="expense.addItem()" :label="$getTranslation('shared.buttons.add')" />
    </template>
    ...
    <template v-slot:body-cell-actions="props">
      <q-td :props="props">
        <q-btn dense round flat color="negative" icon="delete" @click="expense.removeItem(props.pageIndex)">
